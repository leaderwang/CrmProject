...
namespace Models
{
    ...
    public partial class CourseLogic
    {
        ...
        /// Course数据操作对象
        /// </summary>
        private CourseService os = new CourseService();
        /// <summary>
        /// 构造函数
        /// </summary>
        public CourseLogic()
        ...
        public CourseLogic(DBContext obj)
        {
            os = new CourseService(obj);
        }
        /// <summary>
        /// 添加Course
        /// </summary>
        ...
        public int Create(Course obj)
        {
            try
            {
                ...
                string result = os.Add(obj);
                os.Save(result);
                return Convert.ToInt32(new DBContext().ExecuteScalarSql("select max(id) from [Course]"));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// 批量添加
        /// </summary>
        public bool Add(List<Course> obj)
        {
            try
            {
                List<string> result = new List<string>();

                foreach (Course item in obj)
                {
                    if (item.ID == 0)
                    {
        ...
        /// <returns></returns>
        public bool Update(List<Course> olts)
        {
            try
            {
                string sql = "";
		...
		/// <summary>
        /// 根据编号删除Course，此处为逻辑删除，实为更新IsDelete字段
        /// </summary>
        ...
        public bool Delete(int id)
        {
            try
            {
                string result = os.Update(new Course { ID = id, IsDeleted = true });
		...
		/// <summary>
        /// 删除Course，此处为逻辑删除，实为更新IsDelete字段
        /// </summary>
        ...
        public bool Delete(Course obj)
        {
            ...
            try
            {
                var olts = os.GetObjects<Course>(obj);
                if (olts != null)
                {
                    foreach (var item in olts)
                    {
		...
		/// <summary>
        /// 删除Course集合，此处为逻辑删除，实为更新IsDelete字段
        /// </summary>
        /// <param name="objs">删除对象集合</param>
        /// <returns>成功True失败False</returns>
        public bool Delete(IList<Course> objs)
        {
            try
            {
        ...
        public bool Remove(int id)
        {
            try
            {
                string result = os.Delete(new Course { ID = id }, false);
        ...
        /// <param name="obj">查询条件对象</param>
        /// <returns>成功True失败False</returns>
        public bool Remove(IList<Course> objs)
        {
            try
            {
                string result = "";
        ...
        /// 获取Course集合
        /// </summary>
        /// <returns>返回Course集合</returns>
        public List<Course> GetCourses()
        {
            List<Course> objs = os.GetObjects<Course>(new Course() { IsDeleted = false });
        ...
        /// <returns>返回Course集合</returns>
        public List<Course> GetCourses(Course obj)
        {
            obj.IsDeleted = false;

            List<Course> objs = os.GetObjects(obj);
        ...
        /// <returns>返回Course集合</returns>
        public List<Course> GetCourses(Course obj, string where)
        {
            obj.IsDeleted = false;

            List<Course> objs = os.GetObjects(obj, where);
        ...
        /// <returns>返回Course集合</returns>
        public List<Course> GetCourses(Course obj,string where, string order)
        {
            obj.IsDeleted = false;

            List<Course> objs = os.GetObjects(obj, where, order,string.Empty);
        ...
        /// <returns>返回Course集合</returns>
        public List<Course> GetCourses(Course obj, string where,string order,string by)
        {
            obj.IsDeleted = false;

            List<Course> objs = os.GetObjects(obj, where, order,by);
        ...
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(int pageIndex, int pageCount)
        {
            PagedList<Course> objs = os.GetObjects(new Course() { IsDeleted = false }, pageIndex, pageCount);
        ...
        /// <param name="obj">查询条件</param>
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(Course obj, int pageIndex, int pageCount)
        {
            obj.IsDeleted = false;

            PagedList<Course> objs = os.GetObjects(obj,pageIndex, pageCount);
        ...
        /// <param name="obj">查询条件</param>
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(string sql, int pageIndex, int pageCount)
        {
            PagedList<Course> objs = os.GetObjects<Course>(sql, pageIndex, pageCount);
            return objs;
        }
        /// <summary>
        /// 获取Course集合
        ...
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(Course obj, int pageIndex, int pageCount, string where)
        {
            obj.IsDeleted = false;

            PagedList<Course> objs = os.GetObjects(obj, pageIndex, pageCount, where);
        ...
        ///  <param name="orderby">排序</param>
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(Course obj, int pageIndex, int pageCount, string order, string by)
        {
            obj.IsDeleted = false;

            PagedList<Course> objs = os.GetObjects(obj, pageIndex, pageCount, string.Empty, order,by);
        ...
        ///  <param name="orderby">排序</param>
        /// <returns>返回Course集合</returns>
        public PagedList<Course> GetCourses(Course obj, int pageIndex, int pageCount,string where, string order, string by)
        {
            obj.IsDeleted = false;

            PagedList<Course> objs = os.GetObjects(obj, pageIndex, pageCount, where, order, by);
        ...
        /// </summary>
        /// <param name="obj">查询条件</param>
        /// <returns>返回Course</returns>
        public Course GetCourse(Course obj)
        {
			obj.IsDeleted = false;
			
            Course entity = os.GetObject(obj);
        ...
        {
            Course entity = os.GetObject(new Course { ID = id, IsDeleted = false });
	...
	#region 基本数据库访问
    internal partial class CourseService : EntityService
    {
         /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// </summary>
        /// <param name="obj">操作数据库对象</param>
        public CourseService(DBContext obj)
        {
            db = obj;
        }

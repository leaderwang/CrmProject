...
namespace Common
{
    ...
    public class LogHelper
    {
        ...
        public static void Log(string message, string path)
        {
            ...
            FileHelper.AppendFile(path + "log" + DateTime.Now.ToString("yyyyMMdd") + ".htm", "<strong>客户机IP</strong>：" + HttpContext.Current.Request.UserHostAddress + "<br /><strong>错误地址</strong>：" + HttpContext.Current.Request.Url + message + Environment.NewLine);
        }

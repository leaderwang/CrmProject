...
namespace Web.Areas.Admin.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            Member member = new MemberLogic().GetMember(CurrentMember.ID);
            UpdateModel(member);
            new MemberLogic().Update(member);
        ...
        public ActionResult ForgetPwd(string email, FormCollection form)
        {
            ...
            else
            {
                ...
                Member member = new MemberLogic().GetMember(new Member { Email = email });
                if (member != null)
                {

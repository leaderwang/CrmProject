...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class UserLikeController : BaseController
    {
        ...
        public ActionResult Index(int? pageIndex, int? pageSize, UserLike entity)
        {
            try
            {
                UserLikeLogic ml = new UserLikeLogic();
				entity.IsDeleted = false;
				PagedList<UserLike> page = ml.GetUserLikes(entity, pageIndex ?? PageIndex, pageSize ?? PageSize, Order,By);
        ...
        public ActionResult Create(FormCollection formCollection)
        {
            try
            {
                ...
                UserLike obj = new UserLike() {  CreateDate = DateTime.Now, CreateUserID = ID,  IsDeleted = false };

                UpdateModel(obj);

                bool result = ml.Add(obj);

                return result ? Content(ContentIcon.Succeed + "|操作成功|/Admin/UserLike/Index") : Content(ContentIcon.Error + "|操作失败");
            }
            catch (Exception ex)
            {
                return Content(ContentIcon.Error + "|"+ErrorWirter(RouteData, ex.Message));
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                ...
                UserLike obj = ml.GetUserLike(id);

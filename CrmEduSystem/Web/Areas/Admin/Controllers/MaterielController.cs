...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class MaterielController : BaseController
    {
        ...
        public ActionResult Index(int? pageIndex, int? pageSize, Materiel entity)
        {
            try
            {
                MaterielLogic ml = new MaterielLogic();
				entity.IsDeleted = false;
				PagedList<Materiel> page = ml.GetMateriels(entity, pageIndex ?? PageIndex, pageSize ?? PageSize, Order,By);
        ...
        public ActionResult Create(FormCollection formCollection)
        {
            try
            {
                ...
                return result ? Content(ContentIcon.Succeed + "|操作成功|/Admin/Materiel/Index") : Content(ContentIcon.Error + "|操作失败");
            }
            catch (Exception ex)
            {
                return Content(ContentIcon.Error + "|"+ErrorWirter(RouteData, ex.Message));
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                ...
                Materiel obj = ml.GetMateriel(id);

...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class CourseScheduleController : BaseController
    {
        ...
        public ActionResult Index(int? pageIndex, int? pageSize, CourseSchedule entity)
        {
            try
            {
                CourseScheduleLogic ml = new CourseScheduleLogic();
				entity.IsDeleted = false;
				PagedList<CourseSchedule> page = ml.GetCourseSchedules(entity, pageIndex ?? PageIndex, pageSize ?? PageSize, Order,By);
        ...
        {
            return View(new CourseSchedule());
        }
        ...
        public ActionResult Create(FormCollection formCollection)
        {
            try
            {
                ...
                CourseSchedule obj = new CourseSchedule() {  CreateDate = DateTime.Now, CreateUserID = ID,  IsDeleted = false };

                UpdateModel(obj);

                bool result = ml.Add(obj);

                return result ? Content(ContentIcon.Succeed + "|操作成功|/Admin/CourseSchedule/Index") : Content(ContentIcon.Error + "|操作失败");
            }
            catch (Exception ex)
            {
                return Content(ContentIcon.Error + "|"+ErrorWirter(RouteData, ex.Message));
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                ...
                CourseSchedule obj = ml.GetCourseSchedule(id);

    ...
    public class TempleManagerController : BaseController
    {
        ...
        public ActionResult Create(TempInfo ti, string content)
        {
            ...
            try
            {
                ...
                result = true;
                return result ? Content(Web.Areas.Admin.Controllers.BaseController.ContentIcon.Succeed + "|操作成功|/Manager/TempleManager/Index") : Content(Web.Areas.Admin.Controllers.BaseController.ContentIcon.Error + "|操作失败");
            }
            catch (Exception ex)
            {
